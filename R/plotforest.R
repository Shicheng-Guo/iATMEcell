...
##' @usage plotforest(Regress.list,p.cutoff=0.01,g.pos=2,b.size=3,
...
plotforest<-function(Regress.list,p.cutoff=0.01,g.pos=2,b.size=3,col=c("#FE0101","#1C61B6","#A4A4A4"),
                     lwd.zero=2,lwd.ci=3,x.lab="Hazard Ratio Plot"){
